...
let logo = ((data, data_map = {org:'organization', url:'url', x:'x', y:'y',cat:'category'}, selector = '#logos-placeholder') => {
    ...
    var path_position = [{x:0,y:190},{x:698,y:124},{x:656,y:645}]
    var group_position = [{x:85,y:291},{x:832,y:297},{x:749,y:823}]
    var scl = 1, cl_x = 449, cl_y = 0, gb_x = 755 ,gb_y = 20
    } else {
       // margins for SVG
    var margin = {
        left: 0,
    ...
    var path_position = [{x:0,y:444},{x:22,y:99},{x:10,y:771}]
    var group_position = [{x:16,y:501},{x:85,y:196},{x:30,y:971}]
    var scl = 0.543, cl_x = 90, cl_y = 0, gb_x = 375 ,gb_y = 20
    }
